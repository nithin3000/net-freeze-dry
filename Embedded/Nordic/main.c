 ...
 */
static bool pcap_spi_set(SPIModuleNumber mod_num)
{
...
// check this line of code for right function return
uint8_t pcap_spi_tx_rx(SPIModuleNumber mod_num)
{
	bool PCAP_spi_tx_rx = spi_master_tx_rx(PCAP_spi_address, TX_RX_MSG_LENGTH, (const uint8_t *)tx_data, rx_data)
