...
#define SPI_PSELMOSI0             21   /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO0             19   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS0               17   /*!< GPIO pin number for Slave Select           */

/*  SPI1 */
#define SPI_PSELSCK1              23u   /*!< GPIO pin number for SPI clock  23            */
#define SPI_PSELMOSI1             20u  /*!< GPIO pin number for Master Out Slave In  25  */
#define SPI_PSELMISO1             22u  /*!< GPIO pin number for Master In Slave Out  22  */
#define SPI_PSELSS1               21u   /*!< GPIO pin number for Slave Select        24   */
...
#define TIMEOUT_COUNTER          0x3000UL  /*!< timeout for gettin
 * number of bytes to transmit and receive. This amount of bytesg rx bytes from slave */

/** @def  TX_RX_MSG_LENGTH will also be tested to see that
