...
public class ChannelService extends Service
{
   ...
   // private byte[] oldInfo = "99999999".getBytes();
    ...
    public class ChannelServiceComm extends Binder
    {
         ...
         */
        ChannelInfo addNewChannel(final boolean isMaster,final int DN) throws ChannelNotAvailableException
        {
            return createNewChannel(isMaster,DN);
        }
    ...
    public ChannelInfo createNewChannel(final boolean isMaster,final int DN) throws ChannelNotAvailableException
    {
