...
import com.dsi.ant.single.measure.ChannelController.ChannelBroadcastListener;
...
public class ChannelService extends Service
{
    ...
    public class ChannelServiceComm extends Binder
    {
         ...
         */
        ChannelInfo addNewChannel(final boolean isMaster,int devn) throws ChannelNotAvailableException
        {
            return createNewChannel(isMaster, devn);
        }
    ...
    public ChannelInfo createNewChannel(final boolean isMaster,int devn) throws ChannelNotAvailableException
    {
            ...
            if(null != antChannel)
            {
                ...
                {                        
                    ...
                    public void onBroadcastChanged(ChannelInfo newInfo)
                    {
						...
						if(oldInfo != newInfo.broadcastData)
							//oldInfo[0]!= newInfo.broadcastData[0]  && oldInfo[1]!= newInfo.broadcastData[1] && oldInfo[2]!= newInfo.broadcastData[2]&& oldInfo[3]!= newInfo.broadcastData[3]&& oldInfo[4]!= newInfo.broadcastData[4]&& oldInfo[5]!= newInfo.broadcastData[5]&& oldInfo[6]!= newInfo.broadcastData[6]&& oldInfo[7]!= newInfo.broadcastData[7])
                    	{
							mListener.onChannelChanged(newInfo);
							oldInfo = newInfo.broadcastData;
                    	}
